      ...
      <Grid container spacing={2}>
        ...
        {selection.room && (
          <Grid item xs={12} sm={6} md={4}>
            <TextField
              ...
              InputProps={{ inputProps: { min: 1, max: selection.room === "Quad" ? 4 : selection.room === "Triple" ? 3 : selection.room === "Double" ? 2 : 1 } }}
        ...
        <Grid item xs={12} sm={6} md={4}>
          <DatePicker
            ...
            onChange={(newValue) => handleSelection({ target: { name: "date", value: newValue?.toISOString().split("T")[0] }}, 5)}
